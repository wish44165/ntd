...
def main():
    ...
    def run_seed(s):
        ...
        print('-'*40, 'train_transform', '-'*40)
        print(train_transform)
        print('-'*40, 'weak_transform', '-'*40)
        print(weak_transform)
        print('-'*40, 'test_transform', '-'*40)
        ...
        #criterion = SCELoss(alpha=1.0, beta=1.0, num_classes=n_classes)    ######## SCELoss - 1 ########
        kwargs = vars(args)
        method = NTD(criterion=criterion,
                           device=device,
        ...
        for cur_iter in range(args.n_tasks):
            ...
            print('len(cur_train_datalist) =', len(cur_train_datalist))
            print('len(cur_test_datalist) =', len(cur_test_datalist))
